...
interface IOneTokenV1Base is IICHICommon, IERC20 {
    ...
    function init(string memory name_, string memory symbol_, address controller_, address mintMaster_, address memberToken_, address collateral_) external;
    ...
    function setModuleParam(address token, ModuleType moduleType, bytes32 key, bytes32 value) external;

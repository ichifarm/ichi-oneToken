...
contract("uniswapOracleTWAPCompareV2", accounts => {
    ...
    describe('Integration tests with 6/9 decimals', async() => {
		...
		async function setupUniswapOracle(reserve1, reserve2) {
			...
			memberTokenOracle = await UniswapOracleTWAPCompareV2.new(oneTokenFactory.address, 
		...
		it("Bob should be able to mint one Token with UniswapOracleTWAPCompareV2", async () => {
		...
		it("UniswapOracleTWAPCompareV2 read returns correct prices", async () => {
		...
		it("UniswapOracleTWAPCompareV2 amountRequired returns correct prices", async () => {
		...
		it("UniswapOracleTWAPCompareV2 read returns correct prices with 1:2 LP ratio", async () => {
			let reserve1 = 100;
			let reserve2 = 200;
			await setupUniswapOracle(reserve1, reserve2);
		...
		it("UniswapOracleTWAPCompareV2 amountRequired returns correct prices with 1:2 LP ratio", async () => {
			let reserve1 = 100;
			let reserve2 = 200;
			await setupUniswapOracle(reserve1, reserve2);
		...
		it("UniswapOracleTWAPCompareV2 should return the lowest price on read", async () => {
		...
		it("UniswapOracleTWAPCompareV2 should return the highest price on amountRequired", async () => {

...
module.exports = async function({ ethers: { getNamedSigner }, getNamedAccounts, deployments }) {
    ...
    if (chainId == 1) {
        const tokenAddress = '0x0aA7eFE4945Db24d95cA6E117BBa65Ed326e291A'  //OJA  indextoken
        ...
        console.log('OJACompositeOracle: ',oracle.address)
    }
...
module.exports.tags = ["OJACompositeOracle"]

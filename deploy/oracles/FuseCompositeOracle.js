...
module.exports = async function({ ethers: { getNamedSigner }, getNamedAccounts, deployments }) {
    ...
    if (chainId == 1) {
        const tokenAddress = '0x970B9bB2C0444F5E81e9d0eFb84C8ccdcdcAf84d'  //FUSE indextoken
        ...
        console.log('FUSECompositeOracle: ',oracle.address)
    }
...
module.exports.tags = ["FUSECompositeOracle"]

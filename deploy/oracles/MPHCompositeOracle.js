...
module.exports = async function({ ethers: { getNamedSigner }, getNamedAccounts, deployments }) {
    ...
    const 
        name = 'TWAP MPH indexToken Uniswap (sushi) V2 24hr/1hr',
    ...
    if (chainId == 1) {
        const tokenAddress = '0x8888801aF4d980682e47f1A9036e589479e835C5'  //MPH  indextoken
        ...
        console.log('MPHCompositeOracle: ',oracle.address)
    }
...
module.exports.tags = ["MPHCompositeOracle"]
